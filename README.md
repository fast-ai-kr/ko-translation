...
| 완료 | 진행중 | 원제목 | 원링크 | 번역제목 | 번역링크 | 
| -- | -- | ------- | ---- | ------- | ---- |
| <ul><li>- [ ] </li> | <ul><li>- [ ] </li> | Estimating an Optimal Learning Rate For a Deep Neural Network  | [Link](https://towardsdatascience.com/estimating-optimal-learning-rate-for-a-deep-neural-network-ce32f2556ce0) | 미정 | [링크]()
